...
export default class ResultEntry extends Component {
    ...
    render() {
        return(
            <button id={this.props.id} onClick={this.select} type="button" className="list-group-item list-group-item-action" value={this.props.result}><small>{ this.props.result }</small></button>
        );
    }
